<x-customer-layout :store="$store" title="Store Temporarily Unavailable" centered>
    <div class="customer-card customer-card--status px-6 py-8 sm:px-8">
        <div class="text-center">
            ...
            <h2 class="mb-2 text-2xl font-bold">Store temporarily unavailable</h2>
            ...
            <a href="{{ route('join.index', ['slug' => $store->slug, 't' => $token]) }}" class="customer-btn customer-btn-status">
                Back to Store Link
            </a>
        </div>
    </div>
