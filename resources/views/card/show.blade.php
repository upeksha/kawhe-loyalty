                    ...
                    <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden" x-show="isIOS" x-cloak>
                        <div class="p-6">
                            ...
                            <a 
                                ...
                                <img 
                                    src="https://developer.apple.com/assets/elements/badges/add-to-apple-wallet-badge.svg" 
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200" x-show="isAndroid" x-cloak>
                        <div class="p-6">
                            ...
                            <a 
                                ...
                                class="block w-full">
                                <img 
                                    src="https://www.gstatic.com/instantbuy/svg/add_to_google_wallet.svg" 
                                    alt="Add to Google Wallet" 
                                    class="w-full h-auto mx-auto"
                                    style="max-width: 200px; height: auto;"
                                    onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div class="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors shadow-md" style="display: none;">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
