@php
    ...
    $walletBackgroundPattern = old('wallet_background_pattern', \App\Models\Store::WALLET_BACKGROUND_PATTERN_ORGANIC);
    $walletPatternColor = old('wallet_pattern_color', $brandColor);
                ...
                <div class="p-6 sm:p-8 lg:p-10">
                    ...
                    <form method="POST" action="{{ route('merchant.stores.store') }}" enctype="multipart/form-data" id="store-create-form"
                        x-data="{
                            ...
                            walletBackgroundPattern: @js($walletBackgroundPattern),
                            walletPatternColor: @js($walletPatternColor),
                            logoPreview: null,
                            passLogoPreview: null,
                            passHeroPreview: null,
                            stampIconPreview: null,
                            hexToRgb(hex) {
                        ...
                        x-init="
                            ...
                            $refs.stampIconInput?.addEventListener('change', e => { const f = e.target.files[0]; stampIconPreview = f ? URL.createObjectURL(f) : null; });
                        ">
                        @csrf
