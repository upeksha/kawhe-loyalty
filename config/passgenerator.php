...
return [
    ...
    */
    ...
    'certificate_store_path' => env('CERTIFICATE_PATH', 'storage/app/private/passgenerator/certs/certificate.p12'), // The path to the certificate store (a valid PKCS#12 file)
    'certificate_store_password' => env('CERTIFICATE_PASS', ''), // The password to unlock the certificate store
    'wwdr_certificate_path' => env('WWDR_CERTIFICATE', 'storage/app/private/passgenerator/certs/AppleWWDRCA.pem'), // Get from here https://www.apple.com/certificateauthority/ and export to PEM
